...
description: >-
  Reproduce, isolate, and prevent Segment defects and regressions using
  adversarial, deterministic tests. Use for incorrect state, missed or duplicate
  notifications, leaks, transaction failures, derivation errors, resource races,
  SSR or port mismatches, Octane lifecycle issues, flaky tests, or suspicious
  edge cases.
---
# Segment Bug Hunter
