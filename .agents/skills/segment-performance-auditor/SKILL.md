...
description: >-
  Measure, review, and improve Segment performance without sacrificing
  correctness or readability. Use for trie and leaf materialization,
  subscriptions, transactions, derivations, resources, hot paths, allocation,
  memory retention, benchmark changes, performance claims, or suspected
  regressions.
---
