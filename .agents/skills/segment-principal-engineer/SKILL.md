...
description: >-
  Design, implement, refactor, or review Segment architecture and public APIs
  with principal-engineer rigor. Use for changes involving src/core, renderer
  bindings, exported types, state semantics, module boundaries, maintainability,
  extensibility, compatibility, or substantial cross-cutting work.
---
